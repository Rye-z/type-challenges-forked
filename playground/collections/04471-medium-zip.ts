...
type Zip<T extends any[], U extends any[]> = T extends [infer F, ...args: infer R]
  ? U extends [infer _F, ...args: infer _R]
    ? _R extends never ? [[F, _F]] : [[F, _F], ...Zip<R, _R>]
    : []
  : []
